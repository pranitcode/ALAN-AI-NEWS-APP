    ...
    return (
        ...
        <Card ref={elRefs[i]} className={classNames(classes.card, activeArticle === i ? classes.activeCard : null)}>
            ...
            <CardMedia className={classes.media} image={urlToImage || 'https://www.industry.gov.au/sites/default/files/August%202018/image/news-placeholder-738.png'}  />
                ...
                <Typography className={classes.title} gustterBottom varient="h5">{ title }</Typography>
                <CardContent>
                    <Typography varient="body2" color="white" component="p">{ description }</Typography>
                </CardContent>
            ...
            <CardActions className={classes.cardActions}>
                ...
                <Typography varient="h5"  color="white" >{i + 1}</Typography>
            </CardActions>
